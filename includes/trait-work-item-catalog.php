	...
	private static function source_work_queue_definitions(): array {
		return array(
			...
			array(
				...
				'completion_policy'    => 'Choose the smallest honest completion path. If rendered desktop/mobile inspection shows the current source page is already suitable, complete the item with ai-translations/mark-source-design-reviewed and concrete evidence. When repair is needed, use the native source editor contract returned by ai-translations/source-editor-status.',
				'post_type'            => 'post',
