...
trait Devenia_Workflow_Ability_Platform {
	...
	private static function ability_dispatch_handlers(): array {
		return array_merge(
			...
			'enroll_public_header_from_existing_menus' => 'enroll_public_header_from_existing_menus',
			...
			'activate_public_header_projection' => 'activate_public_header_projection',
			'verify_public_header_projection' => 'verify_public_header_projection',
